...
docker exec mysql_master sh -c "export MYSQL_PWD=111; mysql -u root mydb -e 'create table code(first int, middle int, last int); insert into code values (100, 150, 200), (250, 300, 350)'"
